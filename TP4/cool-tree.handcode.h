...
virtual void dump_with_types(ostream&,int) = 0; 		\
virtual int getType() = 0; // Retorna o tipo da feature
...
virtual void dump_with_types(ostream&,int) = 0; \
virtual Symbol getName() = 0; /* Método para retornar  o name de um Formal */


#define formal_EXTRAS                           \
void dump_with_types(ostream&,int); \
virtual Symbol getName() {return name; }  /* Método para retornar  o name de um Formal */
...
virtual void code(ostream&, Scope& scope) = 0; \ /*Adicionado scope */
virtual void dump_with_types(ostream&,int) = 0;  \
...
void code(ostream&, Scope& scope);			   \/*Adicionado scope */
void dump_with_types(ostream&,int); 

#define no_expr_EXTRAS \
bool isNoExpr() {return true;} // Verifica se a expressão é vazia
